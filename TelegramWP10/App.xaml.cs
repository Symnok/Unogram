...
namespace TelegramWP10
{
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            // Answer/Decline from the incoming-call toast arrives here as launch
            // arguments. The navigate above only forwards them on a cold start, so a
            // backgrounded app - the normal case for an incoming call - would have
            // dropped them on the floor.
            if (!string.IsNullOrEmpty(e.Arguments) && MainPage.Current != null)
            {
                MainPage.Current.HandleLaunchArgument(e.Arguments);
            }
