...
namespace TelegramWP10
{
    public static class Loc
    {
        ...
        {
            // ---- voice call UI ----  (callui_ prefix: call_incoming, call_outgoing,
            //       call_declined and call_missed already exist below as chat
            //       message labels, and duplicate keys throw at static init.)
            { "callui_incoming", Row("Incoming call", "Входящий звонок", "Вхідний дзвінок", "שיחה נכנסת") },
            { "callui_outgoing", Row("Calling…", "Вызов…", "Виклик…", "מתקשר…") },
            { "callui_ringing", Row("Ringing…", "Звоним…", "Дзвонимо…", "מצלצל…") },
            { "callui_connecting", Row("Connecting…", "Соединение…", "З'єднання…", "מתחבר…") },
            { "callui_exchangingKeys", Row("Exchanging keys…", "Обмен ключами…", "Обмін ключами…", "מחליף מפתחות…") },
            { "callui_ongoing", Row("Ongoing call", "Разговор", "Розмова", "שיחה פעילה") },
            { "callui_ended", Row("Call ended", "Звонок завершён", "Дзвінок завершено", "השיחה הסתיימה") },
            { "callui_declined", Row("Call declined", "Звонок отклонён", "Дзвінок відхилено", "השיחה נדחתה") },
            { "callui_missed", Row("Missed call", "Пропущенный звонок", "Пропущений дзвінок", "שיחה שלא נענתה") },
            { "callui_failed", Row("Call failed", "Сбой звонка", "Збій дзвінка", "השיחה נכשלה") },
            { "callui_answer", Row("Answer", "Ответить", "Відповісти", "ענה") },
            { "callui_decline", Row("Decline", "Отклонить", "Відхилити", "דחה") },
            { "callui_incompatible", Row("This caller's app uses a newer call protocol", "Приложение звонящего использует новый протокол", "Додаток того, хто дзвонить, використовує новий протокол", "האפליקציה של המתקשר משתמשת בפרוטוקול חדש") },
